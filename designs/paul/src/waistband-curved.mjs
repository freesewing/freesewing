...
function draftPaulWaistbandCurved({
  points,
  Point,
  paths,
  Path,
  ...
  if (options.waistbandCurve === 0) return part.hide()
  ...
  points.ssRightBottom = paths.waistbandBottom.shiftFractionAlong(outseamFraction)
  points.ssLeftBottom = paths.waistbandBottom.shiftFractionAlong(1 - outseamFraction)

  points.ssRightTop = paths.waistbandTop.shiftFractionAlong(outseamFraction)
  points.ssLeftTop = paths.waistbandTop.shiftFractionAlong(1 - outseamFraction)
  ...
  macro('hd', {
    ...
    y: points.edgeRightBottom.y - sa - 10,
  })
  macro('vd', {
    id: 'hTopToSegment1',
    from: points.edgeRightBottom,
    to: points.ssRightBottom,
    x: points.ssRightBottom.x + sa + 10,
  })
  ...
  macro('hd', {
    ...
    to: points.cbBottom,
    y: points.ssRightBottom.y - sa - 10,
  })
  macro('vd', {
    id: 'hSegment1To2',
    from: points.ssRightBottom,
    to: points.cbBottom,
    x: points.cbBottom.x + sa + 10,
  })
  ...
  macro('hd', {
    ...
    y: points.cbBottom.y - sa - 10,
  })
  macro('vd', {
    id: 'hSegment2To3',
    from: points.cbBottom,
    to: points.ssLeftBottom,
    x: points.ssLeftBottom.x + sa + 10,
  })
  macro('hd', {
    id: 'wToFinalSegment',
    from: points.ssLeftBottom,
    to: points.cfLeftBottom,
    y: points.ssLeftBottom.y - sa - 10,
  })
  macro('vd', {
    id: 'hToFinalSegment',
    from: points.ssLeftBottom,
    to: points.cfLeftBottom,
    x: points.cfLeftBottom.x + sa + 10,
  })
  macro('hd', {
    id: 'wWaistband',
    from: points.cfLeftTop,
    to: points.cfLeftBottom,
    y: points.cfLeftTop.y + sa + 10,
  })
  macro('hd', {
  ...
  macro('hd', {
    ...
    from: points.cbTop,
    to: points.ssLeftTop,
    y: points.cbTop.y + sa + 10,
  })
  macro('vd', {
    id: 'hInnerSegment3To4',
    from: points.cbTop,
    to: points.ssLeftTop,
    x: points.cbTop.x - sa - 10,
  })
  ...
  macro('hd', {
    ...
    to: points.cfLeftTop,
    y: points.ssLeftTop.y + sa + 10,
  })
  macro('vd', {
    id: 'hInnerSegment4To5',
    from: points.ssLeftTop,
    to: points.cfLeftTop,
    x: points.ssLeftTop.x - sa - 10,
  })
...
export const waistbandCurved = {
  name: 'paul.waistbandCurved',
  after: [titanBack, titanFront, front, back],
  draft: draftPaulWaistbandCurved,
}
