...
function draftPaulWaistband({
  ...
  // Title
  points.titleAnchor = points.top.shiftFractionTowards(points.bottom, 0.4).translate(-10, 0)
  macro('title', {
  ...
  macro('hd', {
    ...
    y: points.bottomLeft.y + sa + 10,
  })
  macro('vd', {
    id: 'hFull',
    from: points.bottomRight,
    to: points.topRight,
    x: points.bottomRight.x + sa + 10,
  })
...
export const waistband = {
  ...
  options: {
    waistbandCurve: { pct: 0, min: 0, max: 15, menu: 'fit' },
  },
  draft: draftPaulWaistband,
}
