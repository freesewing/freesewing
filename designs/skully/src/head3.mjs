...
export const head3 = {
  ...
  draft: ({ Point, Path, points, paths, sa, complete, log, store, macro, utils, part }) => {
    ...
    macro('hd', {
      ...
      id: 'topDartToBottomRight',
    })
    macro('hd', {
      from: points.dartPoint2,
      to: points.dartPoint1,
      y: points.dartPoint2.y,
      id: 'topDartToDartPoint',
    })
