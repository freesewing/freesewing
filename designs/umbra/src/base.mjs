...
function draftUmbraBase({
  ...
  /**
   * Helper function to rotate a full path around a point
   *
   * @param path {Path} path to rotate
   * @param angle {number} angle to rotate
   * @param rotationOrigin {Point} point to rotate around
   * @return {Path} rotated copy of original path
   */
...
export const base = {
  ...
  options: {
     ...
     */
    gussetPosition: { pct: 50, min: 0, max: 100, menu: 'fit' },
