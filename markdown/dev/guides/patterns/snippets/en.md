...
<Example caption=" Snippets are little embelishments that go on your pattern">
```js
...
<Example caption="Example of the use of snippets">
```js
({ Point, points, Path, paths, Snippet, snippets, part }) => {
  ...
  // Lineless, non-visible path to create boundary box.
  paths.diag = new Path()
    .move(new Point(20,2))
    .move(new Point(85,15))
