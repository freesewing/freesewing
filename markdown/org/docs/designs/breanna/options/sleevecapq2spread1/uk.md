- - -
назва: "Спред донизу по рукавному покриттю Q2"
- - -
...
![На цьому зображенні показано вплив цієї опції шляхом накладання декількох варіантів, які мають різне значення для цієї опції](breanna_sleevecapq2spread1_sample.svg "Вплив цієї опції на шаблон")
