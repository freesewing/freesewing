---
title: "Спред по рукавному покриттю Q4 висхідний"
---
...
![На цьому зображенні показано вплив цієї опції шляхом накладання декількох варіантів, які мають різне значення для цієї опції](breanna_sleevecapq4spread1_sample.svg "Вплив цієї опції на шаблон")
