- - -
назва: "Спред спредів за 4-й квартал донизу"
- - -
...
![На цьому зображенні показано вплив цієї опції шляхом накладання декількох варіантів, які мають різне значення для цієї опції](breanna_sleevecapq4spread2_sample.svg "Вплив цієї опції на шаблон")
