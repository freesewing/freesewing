...
![Додатковий виріз для передньої пройми](./frontarmholedeeper.svg)
...
![На цьому зображенні показано вплив цієї опції шляхом накладання декількох варіантів, які мають різне значення для цієї опції](brian_frontarmholedeeper_sample.svg "Вплив цієї опції на шаблон")
