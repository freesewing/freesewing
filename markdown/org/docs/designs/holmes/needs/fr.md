...
- Environ 0,5 mètre (0,6 yard) d'un tissu approprié ([voir Options de tissu Holmes](/docs/designs/holmes/fabric/))
- Environ 0,5 mètre (0.6 yards) de tissu de doublure ([voir Options de tissu Holmes](/docs/designs/holmes/fabric/))
