---
title: "Pantalons Paco : Ce qu'il te faut"
---

Pour faire Paco, vous aurez besoin des éléments suivants :

- [Fourniture de base pour la couture](/docs/sewing/basic-sewing-supplies)
- Environ 1,25 mètre (en fonction de ta taille) d'un tissu approprié ([voir les options de tissu](/docs/designs/paco/fabric)).
- 30 cm de doublure pour les sacs à pochettes
