...
- Etwa 1 Meter (1,1 Yards) eines geeigneten Hauptstoffs ([siehe Penelope-Stoffoptionen](/docs/designs/penelope/fabric))
...
- (Optional) Etwa 1 Meter (1,1 Yards) eines geeigneten Futterstoffes ([siehe Penelope Stoffoptionen](/docs/designs/penelope/fabric))
