...
![Cette image montre l'effet de cette option en superposant plusieurs variantes qui ont une valeur différente pour cette option](simone_s3armhole_sample.svg "Effet de cette option sur le modèle")
