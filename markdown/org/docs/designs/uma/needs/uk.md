---
title: "Ума роздягається: Що вам потрібно"
---

Для приготування уми вам знадобиться наступне:

- [Базові матеріали для шиття](/docs/sewing/basic-sewing-supplies)
- Приблизно 0,7 метра (0,8 ярдів) відповідної тканини (див. [Варіанти тканин](/docs/designs/uma/fabric))
...
Як і у випадку з будь-яким трикотажем та еластичними тканинами, сергер/оверлок полегшить вам життя. Проте, якщо у Вас її немає - не розчаровуйтесь. Для цього проєкту вона не обов'язкова. Можна просто зшити Уму зигзагоподібним швом.
