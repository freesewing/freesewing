...
If your elastic has a decorative edge, make sure that you line up the plain edge (not the decorative edge) of the elastic to the raw edge of the fabric. El borde decorativo debe estar apuntando hacia la prenda, no lejos de ella.
...
Sew the elastic to the garment using an elastic stitch. Tendrás que estirar un poco el elástico a medida que coser para que quede plana contra la tela. Evite estirar el tejido en sí.
