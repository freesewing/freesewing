...
If your elastic has a decorative edge, make sure that you line up the plain edge (not the decorative edge) of the elastic to the raw edge of the fabric. De decoratieve rand moet naar het kledingstuk wijzen, niet weg.
...
Sew the elastic to the garment using an elastic stitch. Je zal het elastische beetje moeten rekken als je stik om hem plat tegen de stof te laten leggen. Vermijd de stof zelf uit te rekken.
