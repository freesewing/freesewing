...
![Cette image montre l'effet de cette option en superposant plusieurs variantes qui ont une valeur différente pour cette option](yuri_shoulderease_sample.svg "Effet de cette option sur le motif")
