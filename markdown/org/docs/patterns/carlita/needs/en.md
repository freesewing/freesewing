...
- About 5 - 6 metres of a suitable main fabric ([see Carlita Fabric options](/docs/patterns/carlita/fabric/))
- About 3.5 - 4 metres of lining fabric ([see Carlita Fabric options](/docs/patterns/carlita/fabric/))
- About 0.75 - 1 metre of sleeve lining fabric ([see Carlita Fabric options](/docs/patterns/carlita/fabric/))
