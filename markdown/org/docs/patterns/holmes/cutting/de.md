...
Wenn du kein Band für deine Verbindungen verwenden möchtest, kannst du sie aus dem Stoff herstellen. Schneiden Sie einfach 4 Crosskornstreifen von einem 1" (2. cm) oder Breite Ihrer Wahl + Nahtzustände breit und nähen zwei Röhren, so dass eine der kurzen Seiten offen zum Drehen ist. Clicken Sie die Ecken und schneiden Sie Nähte. Stelle einen Druck aus. Wenn gewünscht, können Sie _**Edgestitch**_ oder _**Topstich**_ die Röhren, um den Stoff vom Umschalten zu stoppen. Der rohe Rand der Rohre kann dann beim Bau der Ohrklappen in der Ohrklappe versteckt werden.
