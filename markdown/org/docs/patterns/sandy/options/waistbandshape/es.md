...
![Esta imagen muestra el efecto de esta opción superponiendo varias variantes que tienen un valor diferente para esta opción](sandy_waistbandshape_sample.svg "Effect of this option on the pattern")
