...
![Cette image montre l'effet de cette option en superposant plusieurs variantes qui ont une valeur différente pour cette option](simon\_frontarmholedeeper\_sample.svg "Effet de cette option sur le motif")
