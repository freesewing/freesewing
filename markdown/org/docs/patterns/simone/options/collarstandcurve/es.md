...
![Esta imagen muestra el efecto de esta opción superponiendo varias variantes que tienen un valor diferente para esta opción](simone_collarstandcurve_sample.svg "Effect of this option on the pattern")
