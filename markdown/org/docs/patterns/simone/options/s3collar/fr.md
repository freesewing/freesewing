...
![Cette image montre l'effet de cette option en superposant plusieurs variantes qui ont une valeur différente pour cette option](simone_s3collar_sample.svg "Effect of this option on the pattern")
