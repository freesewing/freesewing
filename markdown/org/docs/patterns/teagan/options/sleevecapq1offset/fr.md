...
![Le décalage au premier trimestre du chapeau de manche](./sleevecapq1offset.svg)
...
![Cette image montre l'effet de cette option en superposant plusieurs variantes qui ont une valeur différente pour cette option](teagan_sleevecapq1offset_sample.svg "Effect of this option on the pattern")
