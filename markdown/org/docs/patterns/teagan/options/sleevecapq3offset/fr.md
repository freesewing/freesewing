...
![Le décalage dans le troisième trimestre de la tête de manche](./sleevecapq3offset.svg)
...
![Cette image montre l'effet de cette option en superposant plusieurs variantes qui ont une valeur différente pour cette option](teagan_sleevecapq3offset_sample.svg "Effect of this option on the pattern")
