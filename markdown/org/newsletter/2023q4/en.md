...
you can just grab as an *off-the-shelf* part so to speak.
...
Googled *free sewing patterns* -- that's *a lot* of effort to go through just
to try the platform. This is why at some point we rolled out a range of
*standard sizes* that people could use instead of their own measurements.
...
*I know I am an XL but your XL did not fit me*. Which is of course our own fault
...
In practical terms, we will be moving away from this idea of *standard sizes*
and instead FreeSewing will provide a list of *curated measurements sets*.
...
elephant in the room: *So we have 3.0 now, when do non-developers get to use
this?*
