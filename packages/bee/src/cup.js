...
delete points.__scaleboxMetric
  //bella alterations
points.sideHemNew = points.armhole.shiftOutwards(points.bustDartTop, points.bustDartBottom.dist(points.sideHemInitial))
points.waistDartRightNew = points.bustA.shift(270 + angle + Math.atan(points.waistDartHem.dist(points.waistDartRight)/points.waistDartHem.dist(points.bustA))*(180/Math.PI),points.bustA.dist(points.waistDartLeft))
...
//bikini top
let underbust = measurements.bustPointToUnderbust + measurements.bustPointToUnderbust*options.bottomCupDepth
points.top = points.bustA.shiftTowards(points.hps, measurements.hpsToBust*options.topDepth)
points.topLeft = points.top.shift(points.top.angle(points.hps)+90,absoluteOptions.neckTieWidth/2)
points.topRight = points.top.shift(points.top.angle(points.hps)-90,absoluteOptions.neckTieWidth/2)
...
points.lefti = utils.beamsIntersect(points.leftDart, points.leftDart.shift(points.leftDart.angle(points.bustA)+90,10), points.cfNeck, points.cfHem)
points.righti = utils.beamsIntersect(points.rightDart, points.rightDart.shift(points.rightDart.angle(points.bustA)-90,10), points.armhole, points.sideHemNew)
points.rightiOffset = points.righti.shiftFractionTowards(points.rightDart,options.sideDepth)
points.sideEdge = points.rightiOffset.shift(points.armhole.angle(points.righti),absoluteOptions.bandTieWidth)
points.frontEdge = points.lefti.shift(points.cfNeck.angle(points.cfHem),absoluteOptions.bandTieWidth)
points.middleDart = points.bustA.shift(points.bustA.angle(points.leftDart) + ((points.bustA.angle(points.rightDart) - points.bustA.angle(points.leftDart))/2), points.bustA.dist(points.leftDart))
points.casingDart = points.bustA.shiftOutwards(points.middleDart,absoluteOptions.bandTieWidth)
points.leftControli = utils.beamsIntersect(points.casingDart, points.casingDart.shift(points.bustA.angle(points.middleDart)-90,10), points.cfNeck, points.cfHem)
points.rightControli = utils.beamsIntersect(points.casingDart, points.casingDart.shift(points.bustA.angle(points.middleDart)+90,10), points.armhole, points.sideHemNew)
...
points.sideCurveControl = points.middleSideFront.shiftFractionTowards(points.bustA,options.sideCurve)
points.middleFront = points.topLeft.shiftFractionTowards(points.lefti,0.5)
points.frontCurveControl = points.middleFront.shiftFractionTowards(points.bustA,options.frontCurve)
points.leftControlOffset = points.leftControl.shiftTowards(points.top,absoluteOptions.bandTieWidth)
points.rightControlOffset = points.rightControl.shiftTowards(points.top,absoluteOptions.bandTieWidth)
...
points.title = points.grainlineBottom.shift(points.bustA.angle(points.top) - 90, points.grainlineTo.dist(points.grainlineBottom))
    macro('title', {
      at: points.title,
      nr: 1,
      title: 'cup',
...
points.logo = points.grainlineTop.shiftOutwards(points.grainlineBottom, points.grainlineTo.dist(points.grainlineBottom)*9)
snippets.logo = new Snippet('logo', points.logo)
.attr("data-rotate",90 - points.bustA.angle(points.top) -270)
.attr("data-scale",0.7);
if (!options.ties) {
	let neckTieLength = utils.units(store.get('neckTieLength'))
	points.neckTieLength = points.__miniscaleImperialBottomLeft.shiftFractionTowards(points.lefti,1/10)
	.attr('data-text','Neck Tie Length: ')
	.attr('data-text',neckTieLength)
	if(!options.crossBackTies){
	let bandTieLength = utils.units((measurements.underbust + measurements.underbust*options.bandTieLength))
	points.backTieLength = points.__miniscaleImperialBottomLeft.shiftFractionTowards(points.lefti,2/10)
...
.setRender(false)
paths.dart = new Path()
.move(points.bustA.shiftOutwards(points.leftDart,points.topRight.dist(points.rightiOffset)))
.line(points.bustA)
.line(points.bustA.shiftOutwards(points.rightDart,points.topRight.dist(points.rightiOffset)))
.setRender(false)
