...
points.topMiddle = new Point (absoluteOptions.neckTieWidth,points.topLeft.y)
	break
    case 'pointed':
points.topMiddle = new Point (absoluteOptions.neckTieWidth,points.topLeft.y - absoluteOptions.neckTieWidth)
  }
...
points.grainlineLeft = points.topLeft.translate(absoluteOptions.neckTieWidth*(1/8),neckTieLength*(3/4))  
points.title = points.topLeft.translate(absoluteOptions.neckTieWidth*(1/8),neckTieLength*(1/4))  
macro('title', {
      at: points.title,
      nr: 2,
      title: 'neck tie',
