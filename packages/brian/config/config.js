...
export default {
  ...
  options: {
    ...
    armholeDepthFactor:    { val:  60, min: 35, max:  75 },
    backNeckCutout:        { val:   5, min:  2, max:   8 },
    bicepsEase:            { val:  15, min:  0, max: 100 },
    chestEase:             { val:   8, min: -4, max:  20 },
    collarEase:            { val: 3.5, min:  0, max:  10 },
    cuffEase:              { val:  20, min:  0, max: 500 },
    ...
    sleevecapQ1Spread1:    { val:   6, min:  0, max:   7 },
    sleevecapQ1Spread2:    { val:  15, min:  0, max:   7 },
    sleevecapQ2Spread1:    { val:  15, min:  0, max:   7 },
    sleevecapQ2Spread2:    { val:  10, min:  0, max:   7 },
    sleevecapQ3Spread1:    { val:  10, min:  0, max:   7 },
    sleevecapQ3Spread2:    { val:   8, min:  0, max:   7 },
    sleevecapQ4Spread1:    { val:   7, min:  0, max:   7 },
    sleevecapQ4Spread2:    { val:   7, min:  0, max:   7 },
