/**
 * @freesewing/components/Draft | v2.6.0-rc.0
...
var Markers = function () {
    ...
    for (var f in d)
      e.push(
        React.createElement(
          ...
          React.createElement('path', _extends({ className: d[f] + ' fill-' + d[f] }, b))
        )
      ),
        e.push(
          React.createElement(
            ...
            React.createElement('path', _extends({ className: d[f] + ' fill-' + d[f] }, c))
          )
        )
    return e
  },
  ...
  Snippets = function () {
    ...
    return [
      React.createElement(
        ...
        React.createElement('circle', _extends({ cy: '0', cx: '0', r: '1.4' }, a)),
        React.createElement('circle', _extends({ cy: '0', cx: '0', r: '2.8' }, b))
      ),
      React.createElement(
        'g',
      ...
      React.createElement(
        ...
        React.createElement('circle', _extends({ cx: '0', cy: '0', r: '3.4' }, b)),
        ' />',
        React.createElement('circle', _extends({ cx: '-1', cy: '-1', r: '0.5' }, a)),
        React.createElement('circle', _extends({ cx: '1', cy: '-1', r: '0.5' }, a)),
        React.createElement('circle', _extends({ cx: '1', cy: '1', r: '0.5' }, a)),
        React.createElement('circle', _extends({ cx: '-1', cy: '1', r: '0.5' }, a))
      ),
      React.createElement(
        ...
        React.createElement('path', _extends({ d: 'M -1,-5 L 1,-5 L 1,5 L -1,5 z' }, b)),
        React.createElement(
          'path',
      ...
      React.createElement(
        ...
        React.createElement('path', _extends({ d: logoPathString }, a))
      )
    ]
  },
  Grid = function (a) {
  ...
  Defs = function (a) {
    ...
    return React.createElement(
      ...
      React.createElement(Grid, { units: a.units }),
      b
    )
  },
    ...
    return (
      ...
      React.createElement(
        ...
        React.createElement(
          'textPath',
          f,
          React.createElement('tspan', a.path.attributes.asPropsIfPrefixIs('data-text-'), c)
        )
      )
    )
  },
  ...
  Path = function (a) {
    ...
    return (
      a.design &&
        b.push(React.createElement(DesignPath, _extends({}, a, { key: 'dpa-' + a.name }))),
      b.push(
        React.createElement(
          'path',
      ...
      a.path.attributes.get('data-text') &&
        b.push(
          React.createElement(TextOnPath, _extends({ key: 'text-on-path-' + a.name, pathId: c }, a))
        ),
      b
    )
  },
  DesignPoint = function (a) {
    return React.createElement(
      ...
      React.createElement('circle', { cx: a.point.x, cy: a.point.y, r: '2', className: 'center' }),
      React.createElement('circle', {
        cx: a.point.x,
        cy: a.point.y,
        r: '7.5',
  ...
  Text = function (a) {
    ...
    if (-1 !== d.indexOf('\n')) {
      var g = 0,
        h = d.split('\n')
      c.push(React.createElement('tspan', { key: 'tspan-' + g }, h.shift()))
      var i,
    ...
    } else c.push(React.createElement('tspan', { key: 'tspan-1' }, d))
    return React.createElement(
      'text',
  ...
  Point = function (a) {
    ...
    return (
      ...
      a.point.attributes.get('data-text') &&
        b.push(React.createElement(Text, _extends({}, a, { key: 'point-' + a.name }))),
      a.point.attributes.get('data-circle') &&
        b.push(React.createElement(Circle, { point: a.point, key: 'circle-' + a.name })),
      1 > b.length ? null : b
    )
  },
  Snippet = function (a) {
    ...
    return (
      ...
      React.createElement('use', _extends({}, b, getProps(a.snippet)))
    )
  },
  Part = function (a) {
    var b = function (b, c) {
        ...
        return React.createElement(
          React.Fragment,
          { key: 'fp' + b },
          React.createElement('path', { d: e, className: f }),
          React.createElement('circle', {
            cx: d.x,
            cy: d.y,
            r: '5',
      ...
      c = function (b, c) {
        ...
        return React.createElement(
          React.Fragment,
          { key: 'cp' + c },
          React.createElement('path', { d: d, className: e }),
          React.createElement('circle', {
            cx: b.x,
            cy: b.y,
            r: '5',
    ...
    return React.createElement(
      ...
      Object.keys(a.part.snippets).map(function (b) {
        return React.createElement(Snippet, { key: b, name: b, snippet: a.part.snippets[b] })
      }),
      e
    )
  },
