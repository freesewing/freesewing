...
const app = {
  ...
  "forgotLoginInstructions": "Якщо Ви не пам'ятаєте свій пароль, напишіть знизу своє ім'я користувача чи електронну адресу та тицьніть кнопку <b>Змінити пароль</b>",
  ...
  "fitYouDeserve": "Ви обділяєте себе, обираючи стандартизовані розміри.<br />Зареєструйтеся сьогодні та отримайте крій, що личить Вам.",
  "supportNag": "<b>Free</b>Seewing є <b>безкоштовною платформою</b>, але ми будемо вдячні, якщо Ви <a href='/patrons/join/'>підтримаєте нас</a>.",
