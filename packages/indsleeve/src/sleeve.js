export default function (part) {
  ...
  // Design pattern here
  let capheight = 139.7 //increased to 5.5 inches
  points.origin = new Point(0, 0)
  points.graintop = points.origin.shift(-90, 15)
  points.cap = new Point(0, -capheight)
  points.bicepright = new Point(measurements.bicepcircum / 2, 0)
  points.bicepleft = points.bicepright.flipX()
  points.wristright = new Point(measurements.wrist / 2, measurements.sleevelength - capheight)
  ...
  let Y = measurements.sleevelength / 2 + 25 - capheight
  points.elbowright = utils.beamIntersectsY(points.bicepright, points.wristright, Y)
  ...
  points.rightcp1 = points.rightnotch1.shift(
    points.capright2.angle(points.bicepright),
    measurements.bicepcircum * options.sleevecapQ1Spread1
  )
  points.rightcp2 = points.rightnotch1.shift(
    points.capright2.angle(points.bicepright),
    measurements.bicepcircum * options.sleevecapQ1Spread2 * -1
  )
  points.rightcp3 = points.rightnotch2.shift(
    points.cap.angle(points.capright2) - 7,
    measurements.bicepcircum * options.sleevecapQ2Spread1
  )
  points.rightcp4 = points.rightnotch2.shift(
    points.cap.angle(points.capright2) - 7,
    measurements.bicepcircum * options.sleevecapQ2Spread2 * -1
  )
  points.leftcp4 = points.leftnotch2.shift(
    points.capleft2.angle(points.cap) + 10,
    measurements.bicepcircum * options.sleevecapQ3Spread1
  )
  points.leftcp3 = points.leftnotch2.shift(
    points.capleft2.angle(points.cap) + 10,
    measurements.bicepcircum * options.sleevecapQ3Spread2 * -1
  )
  points.leftcp2 = points.leftnotch1.shift(
    points.bicepleft.angle(points.capleft2),
    measurements.bicepcircum * options.sleevecapQ4Spread1
  )
  points.leftcp1 = points.leftnotch1.shift(
    points.bicepleft.angle(points.capleft2),
    measurements.bicepcircum * options.sleevecapQ4Spread2 * -1
  )
