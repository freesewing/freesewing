export default function (part) {
    ...
    points.bottomRight = points.origin
     .translate((measurements.hipsCircumference/options.numOfPanels)/2 + options.hemExcess/2 + ((measurements.hipsCircumference/options.numOfPanels) / 2) , options.panelLength);
    ...
    points.lHip = points.lHip.shift(0,measurements.hipsCircumference / options.numOfPanels);
    points.rHip = points.rHip.shift(0,(measurements.hipsCircumference / options.numOfPanels));
    ...
    points.bottomLeft = points.bottomLeft.shift(90,hiphemdifference*0.25);
    ...
    points.rHipcp = points.lHipcp.shift(0,measurements.hipsCircumference / options.numOfPanels)
    points.rHipcp = points.rHipcp.shift(180,((measurements.hipsCircumference / options.numOfPanels)/options.numOfPanels)*2)
