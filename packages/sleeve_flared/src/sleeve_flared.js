export default function (part) {
  ...
  points.wristright = new Point(
    measurements.bicepcircum / 2 + 101.6,
    measurements.sleevelength - capheight
  )
  ...
  let wristdistance = measurements.bicepcircum + 203.2
  ...
  points.wristcpleft = points.wristleft.shift(-45, wristdistance * options.wristcp1spread)
