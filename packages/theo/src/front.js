export default function(part) {
  ...
  points[1] = new Point(points[0].x, measurements.seatDepth - options.waistbandWidth + 10)
  ...
  points[801] = new Point(points[8].x, points[8].y - measurements.seatDepth / 4)
  points[802] = new Point(points[8].x, points[8].y + measurements.seatDepth / 4)
  points[9] = new Point(
