...
`),
  replacements: {
    ...
    closing:
      'You (or someone else) tried to subscribe this email address to the FreeSewing newsletter just now. (note that we already had a pending subscription for this address).',
    greeting: 'love,',
  },
}
