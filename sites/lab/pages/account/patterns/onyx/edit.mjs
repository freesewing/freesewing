...
const EditOnyxPage = ({ page }) => {
  ...
  return (
    // prettier-ignore
    <PageWrapper {...page} title="Onyx" layout={pattern ? WorkbenchLayout : false} header={null}>
      {pattern ? (
        <EditDesignComponent
          id={pattern.id}
