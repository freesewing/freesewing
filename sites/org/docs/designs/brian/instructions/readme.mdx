...
finishes and are for the default Brian block.
:::
...
:::note
Remember to treat Brian as a basis rather than a final product, so adjust what
you need to get the desired look.
For instance:
