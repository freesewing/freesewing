...
const accountSidebar = { docs: [{ type: 'autogenerated', dirName: '.' }] }
...
const config = {
  ...
  plugins: [
    ...
    //  {
    //    id: 'account',
    //    path: 'account', // Path to the second folder
    //    routeBasePath: '/', // URL base path
    //    //sidebarPath: 'accountSidebar', //{ docs: [ { type: 'autogenerated', dirName: '.' } ] }
