...
const EditJasminePage = ({ page }) => {
  ...
  return (
    // prettier-ignore
    <PageWrapper {...page} title="Jasmine" layout={pattern ? WorkbenchLayout : false} header={null}>
      {pattern ? (
        <EditDesignComponent
          id={pattern.id}
...
export default EditJasminePage
