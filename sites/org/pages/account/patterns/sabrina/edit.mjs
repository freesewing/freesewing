...
const EditSabrinaPage = ({ page }) => {
  ...
  return (
    // prettier-ignore
    <PageWrapper {...page} title="Sabrina" layout={pattern ? WorkbenchLayout : false} header={null}>
      {pattern ? (
        <EditDesignComponent
          id={pattern.id}
...
export default EditSabrinaPage
