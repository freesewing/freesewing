...
export default class Exporter {
	...
	constructor(designName, pattern, svg, settings) {
	  ...
	  console.log(`0 0 ${this.wPages * pageWidthInPx} ${this.hPages * pageHeightInPx}`)
	  ...
	  console.log({
	  	widths: {
	  		...
	  		inPx: pageWidthInPx,
	  		svg: this.svgWidth,
	  		totalPts: this.pageWidth * this.wPages,
	  		pattern: pattern.width
	  	},
	  	heights : {
	  		pages: this.hPages,
	  		page: this.pageHeight,
	  		inPx: pageHeightInPx,
	  		svg: this.svgHeight,
	  		totalPts: this.pageHeight * this.hPages,
