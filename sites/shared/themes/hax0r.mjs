...
export const theme = {
  ...
  '--pattern-dev-0': colors.red['300'],
  '--pattern-dev-1': colors.green['300'],
  '--pattern-dev-2': colors.blue['300'],
  '--pattern-dev-3': colors.yellow['300'],
  '--pattern-dev-4': colors.pink['300'],
  '--pattern-dev-5': colors.violet['300'],
  '--pattern-dev-6': colors.teal['300'],
  '--pattern-dev-7': colors.neutral['300'],
